...
@Component({
  selector: "ngx-calls-by-day",
  templateUrl: "./calls-by-day.component.html"
})
export class CallsByDayComponent implements OnInit, OnDestroy {
  stats: any = 0;
  dataSub1: any;
  ...
  init(data) {
    const series =
      (data.totals && data.totals.countdata && data.totals.countdata.series) ||
      [];
