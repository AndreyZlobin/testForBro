...
const translationsGe = {
  ...
  Sad: "Traurig",
  Happy: "Glücklich",
  "Total files on page": "Dateien insgesamt auf Seite",
  "out of": "aus",
  previous: "vorherige",
  next: "nächste",
  ...
  Log: "Protokoll",
  Sort: "Sortieren",
  "Sentiment trend": "Stimmungsentwicklung",
  "Average emotion": "Durchschnittliche Emotion",
  ...
  "Agent: A..Z": "Agent: A..Z",
  "Agent: Z..A": "Agent: Z..A.",
  "Date and time: Newly Uploaded": "Datum und Uhrzeit: Neu hochgeladen",
  "Avg. Pause: Short to Long": "Durchschnitt. Pause: Kurz bis Lang",
  "Tot. Pause: Long to Short": "Tot. Pause: Lang bis Kurz",
  "Stopwords: Max to Min": "Stoppwörter: Max bis Min",
  "Compliance: Low to High": "Einhaltung: Niedrig bis hoch",
  "Compliance: High to Low": "Einhaltung: Hoch bis niedrig",
  "Emotion: High to Low": "Gefühl: Hoch bis niedrig",
  ...
  "Performance by agent, by %": "Leistung nach Agent",
  ...
  "Total minutes by agents": "Gesamtprotokolle nach Agenten",
  ...
  "Avg sentiments by agents": "Durchschnittliche Stimmungen nach Agenten",
  "Sentiment calls by top 6 agents": "Stimmungsaufrufe von Top 6 Agenten",
  "n/a": "k. A.",
  "Avg sentiments by days": "Durchschnittliche Stimmungen nach Tagen",
  "Sentiment calls by days": "Stimmungsaufrufe nach Tagen",
